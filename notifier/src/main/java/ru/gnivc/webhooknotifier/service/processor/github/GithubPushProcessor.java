...
import ru.gnivc.webhooknotifier.util.JsonPathUtil;
import ru.gnivc.webhooknotifier.util.LoggingMessageUtil;
import ru.gnivc.webhooknotifier.util.MessageTemplateUtil;

@Component
public class GithubPushProcessor implements IEventHandler {
